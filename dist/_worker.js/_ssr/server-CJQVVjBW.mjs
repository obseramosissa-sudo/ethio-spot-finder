...
//#region node_modules/.nitro/vite/services/ssr/assets/server-CJQVVjBW.js
var server_CJQVVjBW_exports = /* @__PURE__ */ __exportAll$1({
	a: () => getServerFnById,
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B-bx_K4U.mjs");
...
var manifest = { "f28b3f7e44324071ab1f777257fd8eb0e4daee10b6e901fb7ac6a58f609cd98e": {
	functionName: "getBusinessStorefront_createServerFn_handler",
	importer: () => import("./storefront.functions-B8QiQi8p.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DeRopuGU.mjs").then((n) => n.t),
		import("./start-CyDdosZK.mjs"),
...
//#endregion
export { getServerFnById as a, createServerFn as i, __exportAll as n, server_CJQVVjBW_exports as o, createMiddleware as r, TSS_SERVER_FUNCTION as t };
