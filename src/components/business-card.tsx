...
export function BusinessCard({ b }: { b: Business }) {
  return (
    <Link
      to="/business/$id"
      params={{ id: b.id }}
      className="group flex flex-col overflow-hidden rounded-2xl border border-border bg-card shadow-soft transition hover:-translate-y-0.5 hover:shadow-brand"
    >
